...
> **IMPORTANT (arc-local edit):** This project uses bun exclusively, and a
> PreToolUse hook (`.claude/hooks/block_npm.py`) blocks npm/npx/pnpm/yarn. All
> CLI examples in this skill have been rewritten to `bunx --bun shadcn@latest`.
> Keep it that way — do not restore the upstream runner. Re-apply this edit
> after any `bunx skills update`.
