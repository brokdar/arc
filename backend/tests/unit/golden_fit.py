...
* ``outdoor_ride.fit`` — GPS, power, HR, cadence, speed, altitude and
  ...
  gives, which is the real head unit's behaviour and the only way a
...
#: A golden file whose odometer merely *agreed* with its speed column
