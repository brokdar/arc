...
case that forced it is D200 — a parser that learns to read a new channel cannot
...
written before D200 looks like, and asserts that a rebuild puts it back and
